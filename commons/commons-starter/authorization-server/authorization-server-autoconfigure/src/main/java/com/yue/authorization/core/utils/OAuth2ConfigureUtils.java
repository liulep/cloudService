package com.yue.authorization.core.utils;
...
public class OAuth2ConfigureUtils {
    ...
    public static boolean matchesAuthorizationCodeGrantRequest(HttpServletRequest request) {
        return request.getParameter(OAuth2SystemParameterNames.GRANT_TYPE).equals(
                AuthorizationGrantTypeEnum.EMAIL.getName()
        ) || request.getParameter(OAuth2SystemParameterNames.GRANT_TYPE).equals(
                AuthorizationGrantTypeEnum.PHONE.getName());
    }
